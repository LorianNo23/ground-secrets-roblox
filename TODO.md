...
- [x] Create required planning files.
- [x] Create `default.project.json`.
- [x] Create standard Rojo source folders.
- [x] Add starter shared, server, and client scripts.
- [ ] Verify Rojo sync in Roblox Studio.
